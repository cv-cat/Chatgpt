...
console.log("%c 当前为背景1", 'padding:10px 20px;color:white;background :linear-gradient(90deg, rgb(159, 229, 151), rgb(204, 229, 129))');
"object" == typeof window && (window.Ribbons = function() {
    var t = window
        ...
        new Ribbons(window.backgroundAnimation);